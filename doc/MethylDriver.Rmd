...
In the example shown in the figure below, while the APC and HOXC11 promoters show similar levels of methylation gain in colon cancer, only the APC promoter has a methylation change significantly different to the distribution of its neighborhood. 
